...
:root{
  ...
  --accent:#4ea1ff;--accent2:#86c5ff;--shared:#b982ff;--context:#6b7d92;
...
.locus-chip{
  ...
  gap:12px;text-align:left;align-items:center;width:100%;cursor:pointer;
...
<p class="subtle">Blue nodes belong to one reported sequence, purple nodes are shared by multiple reported
sequences, and gray nodes are neighbor/context nodes included by <code>--neighbors</code>.</p>
</header>
